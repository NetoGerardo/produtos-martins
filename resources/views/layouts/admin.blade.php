            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="/admin/users/list" aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span class="hide-menu">Usuários
                                </span></a>
                        </li>

                        <li class="nav-small-cap"><span class="hide-menu">Relatórios</span></li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="/admin/relatorio" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Indicações
                                </span></a>
                        </li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="/admin/ranking" aria-expanded="false"><i data-feather="info" class="feather-icon"></i><span class="hide-menu">Ranking
                                </span></a>
                        </li>
                    </ul>
                </nav>
