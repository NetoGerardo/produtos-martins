            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="projeto in projetos" :key="projeto.id">
                        ...
                        <td data-label="Descrição">{{ projeto.descricao }}</td>
                        <td data-label="Produto">{{ projeto.tipo_produto }}</td>
                        <td>
                            <button @click="show(projeto)" type="button" class="btn btn-primary btn-sm">
                                Gerenciar
                            </button>
                        </td>
                        <td>
                            <button @click="handleRemove('Deseja deletar ' + projeto.nome, projeto.id, remove)"
