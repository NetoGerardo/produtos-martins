              ...
              <form v-on:submit.prevent="buscarUsuarios()">
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-prepend">
                    <button @click="buscarUsuarios()" style="border-radius:2px;" type="button"
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="usuario in   users" :key="usuario.id">
              ...
              <td>
                <button style="width:100%" @click="show(usuario.usuario)" type="button" class="btn btn-primary btn-sm">
                  Gerenciar
                </button>
              </td>
              <td>
...
export default {
  ...
  methods: {
    ...
    show(usuario) {
      this.editUser(usuario.name, usuario.email, (response) => {
