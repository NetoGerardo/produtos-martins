            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="produto in produtos" :key="produto.id">
                        ...
                        <td data-label="Produto">{{ produto.quantidade }}</td>
                        <td>
                            <button @click="show(produto)" type="button" class="btn btn-primary btn-sm">
                                Gerenciar
                            </button>
                        </td>
                        <td>
                            <button @click="handleRemove('Deseja deletar ' + produto.nome, produto.id, remove)"
